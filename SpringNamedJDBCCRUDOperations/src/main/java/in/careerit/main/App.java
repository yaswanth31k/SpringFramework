...
public class App {
	static NamedParameterJdbcTemplate jdbcTemplate = new AnnotationConfigApplicationContext(JavaConfigFile.class)
	...
	public static boolean insert(String insertQuery, int deptNo, String dName, String loc) {
		Map<String,Object> pap = new HashMap<>();
		pap.put("deptNo",deptNo);
		pap.put("dname",dName);
		pap.put("loc",loc);
		
		return jdbcTemplate.update(insertQuery,pap)>0;
	}
	...
	public static boolean update(String updateQuery, int deptNo, String loc) {
		...
		pap.put("deptNo",deptNo);
		pap.put("loc",loc);
		return jdbcTemplate.update(updateQuery,pap)>0;
	}

	public static boolean delete(String deleteQuery, int deptNo) {
		Map<String,Object> pap = new HashMap<>();
		pap.put("deptNo",deptNo);
		return jdbcTemplate.update(deleteQuery,pap)>0;
	...
	public static List<Dept> getAllDepts(){
		...
		return jdbcTemplate.query(query,new BeanPropertyRowMapper<>(Dept.class));
	}
	public static void main(String[] args) {
		...
		do {
			...
			case 1:
				...
				String insertQuery = "INSERT INTO DEPT VALUES(DEPTNO =:deptNo,DNAME=:dName,LOC=:loc)";
			...
			case 2:
				...
				String updateQuery = "UPDATE DEPT SET LOC=:loc WHERE DEPTNO=deptNo";
				System.out.println("dept no:");
				deptNo = sc.nextInt();
